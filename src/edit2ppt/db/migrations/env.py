...
Loads the database URL from EDIT2PPT_DATABASE_URL (or settings default) and
...
from edit2ppt.config import get_settings
from edit2ppt.db.models import Base

config = context.config

# Override the URL from settings (which reads EDIT2PPT_DATABASE_URL env var).
