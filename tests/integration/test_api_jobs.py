...
from edit2ppt.api import dependencies as deps
from edit2ppt.api.main import app
from edit2ppt.db.models import Base, Job
from edit2ppt.services import jobs as jobs_service
from edit2ppt.services.jobs import FakeJobBus
from edit2ppt.storage import InMemoryStorage
...
def _stub_pipeline(monkeypatch):
    ...
    import sys
    import edit2ppt.tools.convert as convert_module
    ...
    gd = sys.modules["edit2ppt.tools.generate_deck"]
...
class TestGenerateDeckExecutor:
    ...
    async def test_executor_completes_and_publishes_pptx(
        ...
        async with test_db() as session:
            ...
            from edit2ppt.workers.executors.generate_deck import run_generate_deck
            from edit2ppt.workers.executors.registry import ExecutionContext
