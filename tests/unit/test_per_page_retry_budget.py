...
from edit2ppt.tools.types import WarningEntry
...
async def test_exhausted_page_emits_warning_code(monkeypatch):
    ...
    from edit2ppt.tools.execute import execute_batch
    from edit2ppt.tools.generate_deck import GenerateDeckRequest, generate_deck

    # Patch strategize so we control the spec_lock/design_spec.
    from edit2ppt.tools import strategize as strategize_mod
    from edit2ppt.tools.strategize import StrategizeResponse
    from edit2ppt.tools.types import CostBreakdown
    ...
    import sys as _sys
    gd = _sys.modules["edit2ppt.tools.generate_deck"]
    ...
    from edit2ppt.tools.export import ExportResponse
