...
from edit2ppt.tools.execute import _normalise_viewbox_to_canonical
...
def test_content_preserved_inside_wrapper():
    ...
    assert "data-edit2ppt-viewbox-normalise" in out
...
def test_quality_accepts_1920x1080_aspect_match(tmp_path):
    ...
    from edit2ppt.core.svg_quality_checker import SVGQualityChecker
