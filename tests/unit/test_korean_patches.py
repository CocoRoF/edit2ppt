...
from edit2ppt.core.config import DEFAULT_FONT_STACKS, default_font_stack
from edit2ppt.core.svg_to_pptx.drawingml_utils import (
    EA_FONTS,
    FONT_FALLBACK_WIN,
    detect_lang,
    estimate_text_width,
...
class TestOoxmlLangPropagation:
    def test_notes_slide_uses_detected_lang(self):
        from edit2ppt.core.svg_to_pptx.pptx_notes import create_notes_slide_xml
